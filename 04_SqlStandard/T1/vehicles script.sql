...
CREATE TABLE IF NOT EXISTS `vehicles`.`vehicle` (
  ...
  INDEX `fk_vehicle_model_idx` (`model_idmodel` ASC) VISIBLE,
  INDEX `fk_vehicle_make1_idx` (`make_idmake` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `vehicles`.`vehicleincentive` (
  ...
  INDEX `fk_vehicleincentive_incentive1_idx` (`incentive_idincentive` ASC) VISIBLE,
